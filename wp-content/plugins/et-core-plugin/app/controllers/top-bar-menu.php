...
//                ));
            ...
            if (get_theme_mod('etheme_slides', true) && $this->is_elementor) {
                $wp_admin_bar->add_node(array(
                    ...
                    'title' => $menu_icons['etheme_slides'] . esc_html__('Slides', 'xstore-core') . $this->label()->new,
            ...
            if (get_theme_mod( 'etheme_mega_menus', true ) && $this->is_elementor) {
                $wp_admin_bar->add_node(array(
                    ...
                    'title' => $menu_icons['etheme_mega_menus'] . esc_html__('Mega Menus', 'xstore-core') . $this->label()->new,
...
//          }
            ...
            if (in_array('open_ai', $this->settings->show_pages)) {
                $wp_admin_bar->add_node(array(
                    ...
                    'id' => 'et-panel-open-ai',
                    'title' => $menu_icons['open_ai'] . esc_html__('ChatGPT (OpenAI)', 'xstore-core') . $this->label()->new,
...
//            }
            ...
            foreach ($theme_builders as $theme_builder_unique_key => $theme_builder_unique_name) {
                if ( !$is_woocommerce && in_array($theme_builder_unique_key, array('product','product-old', 'product-archive', 'cart', 'checkout') ) )
                    $builder_url = $elementor_builders_url;
                else {
