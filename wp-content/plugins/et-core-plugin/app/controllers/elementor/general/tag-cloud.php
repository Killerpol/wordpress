...
class Tag_Cloud extends \Elementor\Widget_Base
{
    ...
    {
        return __('Tag Cloud', 'xstore-core');
    }
    ...
    {
        return ['woocommerce', 'wordpress', 'shop', 'store', 'filter', 'action', 'tag', 'category', 'product', 'archive'];
    }
    ...
    {
        return ['eight_theme_general', 'woocommerce-elements-single', 'woocommerce-elements-archive'];
    }
