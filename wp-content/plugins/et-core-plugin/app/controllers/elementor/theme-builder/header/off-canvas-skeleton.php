...
//		}
    ...
    protected function render_main_content_head($settings, $should_make_link, $default_url_params) {
        ...
        ?>
        <a <?php echo $should_make_link ? 'href="'.$default_url_params['url'].'"' : ''; ?> class="flex justify-content-center flex-wrap">
            <?php $this->render_icon($settings, true); ?>
...
<!--            <div class="woocommerce-mini-cart__empty-message empty">-->
    ...
    protected function render_icon($settings, $canvas_header = false) {
        ...
        if ( ! empty( $settings['icon'] ) || ! empty( $settings['selected_icon']['value'] ) ) : ?>
            <span class="<?php if ( !$canvas_header ) : ?>elementor-button-icon<?php else: ?>etheme-elementor-off-canvas_content-head-icon full-width<?php endif; ?>">
