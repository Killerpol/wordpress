...
//	    $orderby            = wc_attribute_orderby( $taxonomy );
		...
		$subtype = apply_filters('et_'.$attr->attribute_name.'_swatch_filter_subtype', $subtype);
		$sw_custom_shape = apply_filters('et_'.$attr->attribute_name.'_swatch_filter_shape', $sw_custom_shape);
