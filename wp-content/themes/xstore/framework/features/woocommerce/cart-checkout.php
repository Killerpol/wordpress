...
//        }
	...
	public function header_steps($no_wrapper = false) {
        ...
        elseif ( get_query_var('et_cart-checkout-layout', 'default') == 'default' ) :
			...
			echo '<a href="' . add_query_arg('step', 'payment', $checkout_url) . '" class="' . ($check_pages['is_payment'] ? 'active' : '') . '"' . ($check_pages['is_checkout'] ? 'data-step="payment"' : '') . '> ' . $texts['payment'] . '</a>' . $arrow;
