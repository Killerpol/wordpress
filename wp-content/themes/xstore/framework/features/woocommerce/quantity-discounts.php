...
//            }
    ...
    public function output() {
        ...
        <div class="sales-booster-quantity-discounts-wrapper<?php echo esc_attr($this->args['hidden_default'] ? ' hidden': ''); ?>">
            ...
            <div class="sales-booster-quantity-discounts">
                <?php $this->calculated_discounts($settings); ?>
            </div>
        </div>
        <?php
    }
            ...
            <div class="quantity-discount-item">
                <div class="quantity-discount-info">
                    ...
                    if ( $settings['rules'] == 'intervals')
                        echo sprintf(__('%1s Buy from %2s to %3s items and get %4s OFF %5s %6s on each product %7s', 'xstore'), '<'.$settings['discount_title_tag'].' class="quantity-discount-name">', $discount['min'], ($discount['max'] ? $discount['max'] : '&#8734;'),
                ...
                <div class="quantity-discount-add">
                    <?php
                    if ( $settings['rules'] == 'intervals' && $settings['add_quantity'] == 'on') :
                        ...
                        woocommerce_quantity_input( array(
                            ...
                            'max_value' => $discount['max'] ? $discount['max'] : '',
