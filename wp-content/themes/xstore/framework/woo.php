...
if ( ! function_exists( 'etheme_template_hooks' ) ) {
	function etheme_template_hooks() {
		...
		if ( etheme_get_option( 'enable_brands', 1 ) && etheme_get_option( 'show_brand', 1 ) ) {
...
if ( ! function_exists( 'etheme_get_mini_cart_empty' ) ) {
	function etheme_get_mini_cart_empty(){
        ...
        <div class="woocommerce-mini-cart__empty-message empty">
            <p><?php esc_html_e( 'No hay productos en el carrito.', 'xstore' ); ?></p>
    ...
    <script type="text/html" id="tmpl-et-variation-gallery-slider-template">
        <div class="swiper-slide">
            <div class="woocommerce-product-gallery__image">
                <a data-elementor-open-lightbox="no" data-elementor-lightbox-slideshow="all-slide-<?php echo $post->ID; ?>" href="{{data.url}}" data-large="{{data.full_src}}" data-width="{{data.full_src_w}}" data-height="{{data.full_src_h}}" data-index="{{data.index}}" class="woocommerce-main-image <# if (data.index < 1) { #> pswp-main-image <# } #> zoom">
