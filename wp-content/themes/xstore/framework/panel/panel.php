        ...
        if ( isset($this->page['script']) && ! empty($this->page['script']) ){
            ...
            switch ($this->page['script']) {
                ...
                case 'welcome.min':
                    ...
                    wp_enqueue_style( 'slick-carousel', get_template_directory_uri() . '/css/libs/slick.css' );
                    break;
            }
        }
...
//                }
                ...
                foreach ($theme_builders as $theme_builder_unique_key => $theme_builder_unique_info) {
                    ...
                    if ( !$is_wc && in_array($theme_builder_unique_key, array('product','product-old', 'product-archive', 'cart', 'checkout') ) )
                    ...
                    if ( $allow_elementor_builder ) {
                        if ( in_array($theme_builder_unique_key, array('cart', 'checkout')) ) {
                            if ($has_pro) {
                                if (
