            ...
            <div class="domain-selectors">
                <div class="domain-selector<?php //echo (!$is_staging) ? " active": ""; ?>">
                    <h4>
                        ...
                        <label for="et_register_domain_type_live"><?php echo esc_html__('Live Website', 'xstore'); ?></label>
                    </h4>
                ...
                <div class="domain-selector<?php //echo ($is_staging) ? " active": ""; ?>">
                    <h4>
                        ...
                        <label for="et_register_domain_type_staging"><?php echo esc_html__('Staging Website', 'xstore'); ?></label>
                    </h4>
