...
<div class="cart-empty empty-cart-block wc-empty-cart-message">
	...
	<?php if ( wc_get_page_id( 'shop' ) > 0 ) : ?>
		<p><a class="btn black<?php echo esc_attr( $button_class ? ' ' . $button_class : '' ); ?>" href="<?php echo get_permalink(wc_get_page_id('shop')); ?>"><span><?php esc_html_e('Retornar a la tienda', 'xstore') ?></span></a></p>
	<?php endif; ?>
</div>